...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        // TODO: Angular
        public double par0YTicks = -2452.165233066315; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2130.4097255063666; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2000.8226002678518; // x position of the perpendicular encoder (in tick units)
    }
